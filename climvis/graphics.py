...
def plot_annual_cycle(df, filepath=None):
    '''
    This fuction plots the annual cycle of 
    ...
    ----------
    df : pandas dataframe
        datframe containing the climate data to be plotted

    filepath : str
        Optional file path to to save the plot. If not 
        provided, plot will be displayed but not saved

    Returns:
    ----------
    f : matplotlib figure object
        object conataining th e figure generated by function
    '''
